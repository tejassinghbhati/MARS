...
const MOCK_RESULTS = [
  ...
  {
    keywords: ['mars', 'modular agent runtime', 'mars runtime'],
    results: [
      {
        title: 'MARS — Modular Agent Runtime System',
        snippet: 'MARS is a modular AI agent runtime by Tejas Singh Bhati: Claude tool-use, SQLite + Chroma memory, multi-platform bots, scheduled fabric, and hot-loadable skills.',
  ...
  },
  {
    ...
    results: [
      {
        title: 'MARS (formerly OpenClaw stack)',
        snippet: 'The unified codebase is now branded MARS: Modular Agent Runtime System.',
        url: 'https://example.com/mars',
      },
    ],
  },
